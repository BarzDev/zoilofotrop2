  ...
  return (
    <div className="">
      ...
      <div className="flex flex-wrap gap-3 items-center justify-center">
        <IconImage title="HTML" img="icon/html.svg" color="orange" w="28" />
        <IconImage title="CSS" img="icon/css.svg" color="blue" w="28" />
        <IconImage title="Javascript" img="icon/js.svg" color="amber" w="36" />
        <IconSVG
          title="Bootstrap"
          img="icon/js.svg"
          color="violet"
        ...
        <IconImage
          ...
          w="36"
        />
        <IconImage title="MongoDB" img="icon/mongodb.svg" color="lime" w="36" />
        <IconImage
          title="Postgres"
        ...
        <IconSVG
          ...
          path={reduxSVG}
        />
        <IconImage title="NextJS" img="icon/nextjs.svg" w="36" bg="bg-white" />
        <IconImage title="NodeJS" img="icon/nodejs.svg" color="lime" w="32" />
      </div>
    </div>
  );
};
