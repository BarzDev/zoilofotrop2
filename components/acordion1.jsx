      ...
      <Accordion.Panel>
        ...
        <Accordion.Content className="bg-slate-300">
          <p className="playpen sm:text-justify text-left sm:text-base text-xs">
            Barz Store is an ecommerce store which created use Next.js,
            Taildwind, and a some Public API. Do fetch product with API, make a
            cart, and create transaction history.
          </p>
          <Button
            as={Link}
            href={"https://barz-store.vercel.app/"}
            target="blank"
            color="dark"
