      ...
      <Accordion.Panel>
        ...
        <Accordion.Content className="bg-slate-300">
          <p className="playpen sm:text-justify text-left sm:text-base text-xs">
            Card hero list, is an API fetch hero from dota2 game, and display it
            in a card list, display detail match per hero in the list. Sorting
            feature by primary attribute, and search feature will be comming
            soon.
          </p>

          <Button
            as={Link}
            href={"https://card-list-dota-api.vercel.app"}
            target="blank"
            color="dark"
